...
const AddContact = () => {
  ...
  useEffect(() => {
    if (contactToUpdate) {
      ...
      setnewTime(contactToUpdate.newTime);
      setImp(contactToUpdate.imp);
...
try {
  ...
  var metaData= { // to know the type of file ie jpg,mp3
  ...
  var uploadTask = storageRef
   ...
   // uploadTask.on( TaskEvent, upload status,error,  callback to take the image url)
   uploadTask.on(
            ...
            <FormGroup check>
              <Label check>
                <Input
                  ...
                  checked={star}
                />{" "}
                <span className="text-right pr-5">Mark as Star </span>
              </Label>
            </FormGroup>
            <FormGroup check>
              <Label check>
                <Input
                  ...
                  checked={imp}
                />{" "}
                <span className="text-right">Mark as Important</span>
              </Label>
            </FormGroup>
